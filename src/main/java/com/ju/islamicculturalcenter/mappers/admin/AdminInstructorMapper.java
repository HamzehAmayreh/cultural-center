    ...
    public InstructorEntity mapDtoToEntity(AdminInstructorRequestDto requestDto) {
        ...
        return InstructorEntity.builder()
                .user(UserEntity.builder()
                        ...
                        .build())
                .imageUrl(nonNull(requestDto.getImageUrl()) ? requestDto.getImageUrl(): "https://islamic-cultrual-center.s3.amazonaws.com/585e4bf3cb11b227491c339a2023-01-16T20:45:08.199740.png")
