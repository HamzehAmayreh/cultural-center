    ...
    public void registerToCourse(StudentCourseRequestDto requestDto) {
        List<String> violations = new CompositeValidator<StudentCourseRequestDto, String>()
                ...
                .addValidator(r -> isNull(r.getInstructorId()) || isNull(r.getCourseId()) || instructorCoursesRepo.exists(Example.of(InstructorCoursesEntity.builder()
                        .active(true)
                        .course(CourseEntity.builder().id(requestDto.getCourseId()).active(true).build())
                        .instructor(InstructorEntity.builder().id(requestDto.getInstructorId()).active(true).build())
                        .build())),"Instructor is not registered to this course id")
    ...
    private StudentCourseResponse mapAvailableCourses(CourseEntity course) {
        return StudentCourseResponse.builder()
                ...
                .instructors(instructorCoursesRepo.findAll(Example.of(InstructorCoursesEntity.builder()
                                ...
                                .course(CourseEntity.builder().id(course.getId()).active(true).build())
                                .build())).stream()
